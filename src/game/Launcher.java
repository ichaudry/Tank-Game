...
import game.menus.EndGamePanel;
import game.menus.StartMenuPanel;
...
public class Launcher {
    ...
    public Launcher(){
        ...
        this.jf.setTitle("Tank Wars"); // setting the title of the JFrame window.
...
//                MusicPlayer player=new MusicPlayer("GoodFight");
//                (new Thread(player)).run();

                (new Thread(this.gamePanel)).start();
//                Thread gameThread=new Thread(this.gamePanel);
//                gameThread.start();
//
