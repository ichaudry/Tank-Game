...
public class BoundaryTile extends Tile {
    public BoundaryTile(int x, int y, ID id, ObjectManager objectManager) {
    ...
    public void render(Graphics g) {
        g.drawImage(Resources.boundaryWall,x,y,GameConstants.TILE_WIDTH,GameConstants.TILE_HEIGHT,null);
    }
